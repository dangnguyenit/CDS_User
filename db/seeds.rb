...
if Permission.count == 0
  ...
  user_pa = Permission.create(      :name => "User PA",                                                :code => "user_pa",                                        :group_permission_name => "Manage Users PA")
...
if UserGroup.count == 0
  ...
  group_bod = UserGroup.create(name: "BoD", organization: admin_org)
    group_bod.permission_ids = user_pa.id
...
if User.count == 0
  ...
  creaate_user = User.create(full_name: "Administrator", first_name: 'Site', last_name: "Administrator", email: "admin@elarion.com", password: "123456", password_confirmation: "123456", is_admin: true, user_groups: [group], organization: admin_org, staff_number: "32767", status: true)
  # hr_user = User.create(full_name: 'Human Resource', last_name: "HR", email: "hr@elarion.com", password: "123456", password_confirmation: "123456", is_hr: true, user_groups: [group_hr], organization: admin_org, staff_number: "32766")
  # bod_user = User.create(full_name: 'Broad of Director', last_name: "BoD", email: "bod@elarion.com", password: "123456", password_confirmation: "123456", is_bod: true, user_groups: [group_bod], organization: admin_org, staff_number: "32765")
...
if ScoringScale.count == 0
  ...
  scoring_scale_for_technique = ScoringScale.create(name: "Scoring Scale for Technical Skills")
    ...
    scoring4_for_technique = Scoring.create(score: "4", description: "PMP (internal)", scoring_scale_id: scoring_scale_for_technique.id)
    scoring5_for_technique = Scoring.create(score: "5", description: "PMP", scoring_scale_id: scoring_scale_for_technique.id)
end
...
if Title.count == 0
  ...
  title4a = Title.create(name: "Associate Technique Architect", short_name: "ATA", value: 4, career_path: "technique", title_group_id: title_group.id)
    ...
    rank3_title4a = Rank.create(number_competencies_next_level: 4, title_id: title4a.id)
      ...
      title4a_other_subject5 = TitleGroupsOtherSubject.create(title_group_id: title_group.id, other_subject_id: other_subject_technique.id, cds_template_id: cds_template.id, title_id: title4a.id, scoring: "4")
  ...
  title5a = Title.create(name: "Technique Architect", short_name: "TA", value: 5, career_path: "technique", title_group_id: title_group.id)
    ...
    rank3_title5a = Rank.create(number_competencies_next_level: 4, title_id: title5a.id)
      ...
      title5a_other_subject5 = TitleGroupsOtherSubject.create(title_group_id: title_group.id, other_subject_id: other_subject_technique.id, cds_template_id: cds_template.id, title_id: title5a.id, scoring: "4")
  ...
  title6a = Title.create(name: "Senior Technique Architect", short_name: "STA", value: 6, career_path: "technique", title_group_id: title_group.id)
    ...
    rank3_title6a = Rank.create(number_competencies_next_level: 4, title_id: title6a.id)
      ...
      title6a_other_subject5 = TitleGroupsOtherSubject.create(title_group_id: title_group.id, other_subject_id: other_subject_technique.id, cds_template_id: cds_template.id, title_id: title6a.id, scoring: "4")
  ...
  title6b = Title.create(name: "Senior Engieering Manager", short_name: "SEM", value: 6, career_path: "management", title_group_id: title_group.id)
    ...
    rank3_title6b = Rank.create(number_competencies_next_level: 4, title_id: title6b.id)
      ...
      title6b_other_subject5 = TitleGroupsOtherSubject.create(title_group_id: title_group.id, other_subject_id: other_subject_technique.id, cds_template_id: cds_template.id, title_id: title6b.id, scoring: "5")
...
if User.count > 0
  ...
  hr_user = User.create(full_name: 'Nguyen Mai Le', email: "lenm@elarion.com", password: "123456", password_confirmation: "123456", is_hr: true, user_groups: [group_hr], organization: admin_org, staff_number: "32766", status: true)
  hr_department = Department.create(name: "Human Resources", description: "This is department for HR", manager_id: hr_user.id, cds_template_id: cds_template.id, status: true)
  UsersDepartment.create(user_id: hr_user.id, department_id: hr_department.id)

  bod_user = User.create(full_name: 'Lai Duc Nhuan', email: "nhuanld@elarion.com", password: "123456", password_confirmation: "123456", is_bod: true, user_groups: [group_bod], organization: admin_org, staff_number: "32765", status: true)
  bod_department = Department.create(name: "Board of Directors", description: "This is department for BoD", manager_id: bod_user.id, cds_template_id: cds_template.id, status: true)
  UsersDepartment.create(user_id: bod_user.id, department_id: bod_department.id)

  manage_user = User.create(full_name: "Nguyen Nguyen Binh", email: "binhnn@elarion.com", password: "123456", password_confirmation: "123456", user_groups: [group_staff], staff_number: "01", is_manager: true, career_path: "management", organization_id: 1, status: true)
  department = Department.create(name: "RGM", description: "This is RGM Project", manager_id: manage_user.id, cds_template_id: cds_template.id, status: true)
  manage_user.update_attributes(main_department_id: department.id, pre_department_id: department.id)
  UsersDepartment.create(user_id: manage_user.id, department_id: department.id)
    # create_slot_assess_for_user(manage_user.id)
    # manage_user.slot_assesses.where(competency_name: "Productivity", level_name: ["Level 1", "Level 2", "Level 3"]).each do |sa|
    #   sa.update_attributes(value: "4", status: "Passed", approved_user_id: 3)
    # end

    # manage_user.slot_assesses.where(competency_name: "Problem Solving", level_name: ["Level 1", "Level 2", "Level 3"]).each do |sa|
    #   sa.update_attributes(value: "4", status: "Passed", approved_user_id: 3)
    # end

    # manage_user.slot_assesses.where(competency_name: "Knowledge and Skills", level_name: ["Level 1", "Level 2", "Level 3"]).each do |sa|
    #   sa.update_attributes(value: "4", status: "Passed", approved_user_id: 3)
    # end

    # manage_user.slot_assesses.where(competency_name: "Planning and Organizing", level_name: ["Level 1", "Level 2", "Level 3", "Level 4"]).each do |sa|
    #   sa.update_attributes(value: "4", status: "Passed", approved_user_id: 3)
    # end

    # manage_user.slot_assesses.where(competency_name: "Communication", level_name: ["Level 1", "Level 2", "Level 3", "Level 4"]).each do |sa|
    #   sa.update_attributes(value: "4", status: "Passed", approved_user_id: 3)
    # end

  
  # Technique Leader
  test_user2 = User.create(full_name: "Vo Kinh Luan", email: "luanvk@elarion.com", password: "123456", password_confirmation: "123456", user_groups: [group_staff], staff_number: "02", career_path: "technique", organization_id: 1, team_leader_id: manage_user.id, main_department_id: department.id, pre_department_id: department.id, status: true, is_team_leader: true)
  UsersDepartment.create(user_id: test_user2.id, department_id: department.id)



  test_user3 = User.create(full_name: "Ngo Duy Khanh", email: "khanhnd@elarion.com", password: "123456", password_confirmation: "123456", user_groups: [group_staff], staff_number: "03", career_path: "technique", organization_id: 1, team_leader_id: manage_user.id, main_department_id: department.id, pre_department_id: department.id, status: true, is_team_leader: true)
  UsersDepartment.create(user_id: test_user3.id, department_id: department.id)

    

  # Team Memnber
  test_user4 = User.create(full_name: "Pham Thi Mai Anh", email: "anhptm@elarion.com", password: "123456", password_confirmation: "123456", user_groups: [group_staff], staff_number: "04", career_path: "management", organization_id: 1, team_leader_id: test_user2.id, main_department_id: department.id, pre_department_id: department.id, status: true)
  UsersDepartment.create(user_id: test_user4.id, department_id: department.id)

  test_user5 = User.create(full_name: "Pham Thi Thu Hien", email: "hienptt@elarion.com", password: "123456", password_confirmation: "123456", user_groups: [group_staff], staff_number: "05", career_path: "management", organization_id: 1, team_leader_id: test_user2.id, main_department_id: department.id, pre_department_id: department.id, status: true)
  UsersDepartment.create(user_id: test_user5.id, department_id: department.id)

  test_user6 = User.create(full_name: "Le Truc Anh", email: "anhlt@elarion.com", password: "123456", password_confirmation: "123456", user_groups: [group_staff], staff_number: "06", career_path: "management", organization_id: 1, team_leader_id: test_user2.id, main_department_id: department.id, pre_department_id: department.id, status: true)
  UsersDepartment.create(user_id: test_user6.id, department_id: department.id)

  test_user7 = User.create(full_name: "Nguyen Khoa Hai Long", email: "longnkh@elarion.com", password: "123456", password_confirmation: "123456", user_groups: [group_staff], staff_number: "07", career_path: "management", organization_id: 1, team_leader_id: test_user3.id, main_department_id: department.id, pre_department_id: department.id, status: true)
  UsersDepartment.create(user_id: test_user7.id, department_id: department.id)

  test_user8 = User.create(full_name: "Pham Tan Khoa", email: "khoapt@elarion.com", password: "123456", password_confirmation: "123456", user_groups: [group_staff], staff_number: "08", career_path: "management", organization_id: 1, team_leader_id: test_user3.id, main_department_id: department.id, pre_department_id: department.id, status: true)
  UsersDepartment.create(user_id: test_user8.id, department_id: department.id)

  test_user9 = User.create(full_name: "Cao Sy Le", email: "lecs@elarion.com", password: "123456", password_confirmation: "123456", user_groups: [group_staff], staff_number: "09", career_path: "management", organization_id: 1, team_leader_id: test_user3.id, main_department_id: department.id, pre_department_id: department.id, status: true)
  UsersDepartment.create(user_id: test_user9.id, department_id: department.id)

  test_user10 = User.create(full_name: "Tran Dinh Dung", email: "dungtd@elarion.com", password: "123456", password_confirmation: "123456", user_groups: [group_staff], staff_number: "10", career_path: "management", organization_id: 1, team_leader_id: test_user3.id, main_department_id: department.id, pre_department_id: department.id, status: true)
  UsersDepartment.create(user_id: test_user10.id, department_id: department.id)

  test_user11 = User.create(full_name: "Pham Duc Huy", email: "huypd@elarion.com", password: "123456", password_confirmation: "123456", user_groups: [group_staff], staff_number: "11", career_path: "management", organization_id: 1, team_leader_id: test_user3.id, main_department_id: department.id, pre_department_id: department.id, status: true)
  UsersDepartment.create(user_id: test_user11.id, department_id: department.id)

  test_user12 = User.create(full_name: "Nguyen Tai Thien", email: "thiennt@elarion.com", password: "123456", password_confirmation: "123456", user_groups: [group_staff], staff_number: "12", career_path: "management", organization_id: 1, team_leader_id: test_user3.id, main_department_id: department.id, pre_department_id: department.id, status: true)
  UsersDepartment.create(user_id: test_user12.id, department_id: department.id)

  test_user13 = User.create(full_name: "Pham Nguyen Phu Khanh", email: "khanhpnp@elarion.com", password: "123456", password_confirmation: "123456", user_groups: [group_staff], staff_number: "13", career_path: "management", organization_id: 1, team_leader_id: test_user3.id, main_department_id: department.id, pre_department_id: department.id, status: true)
  UsersDepartment.create(user_id: test_user13.id, department_id: department.id)

  test_user14 = User.create(full_name: "Thieu Van Tuan", email: "tuantv@elarion.com", password: "123456", password_confirmation: "123456", user_groups: [group_staff], staff_number: "14", career_path: "management", organization_id: 1, team_leader_id: test_user3.id, main_department_id: department.id, pre_department_id: department.id, status: true)
  UsersDepartment.create(user_id: test_user14.id, department_id: department.id)

  # test_user15 = User.create(full_name: "Nguyen Hai Dang", email: "dangnh@elarion.com", password: "123456", password_confirmation: "123456", user_groups: [group_staff], staff_number: "15", career_path: "management", organization_id: 1, team_leader_id: test_user3.id, main_department_id: department.id, pre_department_id: department.id, status: true)
  # UsersDepartment.create(user_id: test_user15.id, department_id: department.id)
