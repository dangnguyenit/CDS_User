...
ActiveRecord::Schema.define(:version => 20140610081810) do
  ...
  add_index "photos", ["evidence_id"], :name => "index_photos_on_evidence_id"
  ...
  create_table "users", :force => true do |t|
    ...
    t.boolean  "is_bod"
    t.boolean  "is_hr"
    t.integer  "main_department_id"
    t.integer  "pre_department_id"
